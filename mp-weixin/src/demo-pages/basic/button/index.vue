  ...
  <CustomPage title="按钮" :is-h5-demo-page="isDemoH5Page">
    <DemoContainer title="基础">
      <view class="button-container">
        <view class="button-item">
          ...
          <view class="item">
            <TnButton text>文本按钮</TnButton>
          </view>
          <view class="item">
            <TnButton plain>朴素按钮</TnButton>
          </view>
        </view>
      </view>
    </DemoContainer>
    ...
    <DemoContainer title="按钮尺寸">
      <view class="button-container">
        <view class="button-item">
          ...
          <view class="item">
            <TnButton font-size="50rpx" :custom-style="{ padding: '16rpx 30rpx' }">
              按钮
            </TnButton>
          </view>
        </view>
    ...
    <DemoContainer title="按钮形状">
      <view class="button-container">
        <view class="button-item">
          ...
          <view class="item">
            <TnButton width="80" shape="circle" icon="logo-tuniao" font-size="56" />
          </view>
        </view>
      </view>
    </DemoContainer>
    ...
    <DemoContainer title="修改颜色">
      <view class="button-container">
        <view class="button-item">
          ...
          <view class="item">
            <TnButton bg-color="rgba(1, 190, 255, 0.2)" text-color="tn-type-primary">
              按钮
            </TnButton>
          </view>
          <view class="item">
          ...
          <view class="item">
            <TnButton width="80" bg-color="gradient-bg__cool-6" text-color="tn-white" shape="circle" icon="logo-tuniao"
              font-size="56" />
          </view>
        </view>
        <view class="button-item">
    ...
    <DemoContainer title="自定义样式">
      <view class="button-container">
        <view class="button-item">
          <view class="item">
            <TnButton bg-color="tn-gray-disabled" :custom-style="{
